...
export const parserValues = z.object({
...
export const linkSchema = parserValues
  .extend({
    label: z.string(),
...
export const parameterSchema = fieldProperties
  .extend({
...
export const filterSchema = fieldProperties
  .extend({
...
export const measureSchema = fieldProperties
  .extend({
    drill_fields: z.array(z.string()).optional(),
...
export const setSchema = parserValues
  .extend({
    fields: z.array(z.string()),
  })
  .strict();

export const joinSchema = parserValues
  .extend({
...
export const aggregateTableSchema = parserValues
  .extend({
    query: parserValues
      .extend({
...
export const derivedTableSchema = z
  .object({
...
export const LookMLView = parserValues
  .extend({
    $name: z.string(),
    access_filter: z
      .record(
