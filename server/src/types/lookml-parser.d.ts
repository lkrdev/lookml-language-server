declare module "lookml-parser" {
  ...
  export interface LookmlFile {
    ...
    manifest?: Record<
      string,
      LookmlFileAttributes & { manifest: { [key: string]: LookmlManifest } }
    >;
    dashboard?: Record<
      string,
      LookmlFileAttributes & { dashboard: { [key: string]: LookmlDashboard } }
    >;
  }
  ...
  export interface LookmlDashboardWithFileInfo extends LookmlDashboard {
    file: LookmlFileAttributes;
    uri: string;
    positions: Position;
  }
  ...
  export function parse(
    lkml: string
  ): LookmlModel | { view: LookmlView } | { explore: LookmlExplore };
